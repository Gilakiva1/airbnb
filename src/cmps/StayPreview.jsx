        ...
        <Link className="link-detail" to={`/stay/${stay._id}?${queryString}`}>
            <div className="stay-container">
                ...
                <div className="flex column mrt10">
                    <h2 className="fs14 fh18 airbnb-book fw-unset mrb2"> {<FontAwesomeIcon className='star-icon clr3' icon={faStar} />} <span className="clr2">{utilService.getRandomIntInclusive(3, 5)}</span> <span className="clr1">({utilService.getRandomIntInclusive(30, 500)})</span></h2>
