                ...
                <div className="hero-logo full relative">
                    {screenWidth > 550 &&
                        <div className="btn-flex-container fh20  absolute flex align-center column">
                            <h1 className="fs18 medium clr2 fw-unset">Not sure where to go? Perfect. </h1>
                            <Link to="/stay" className="btn-flex"><span style={{ '-webkit-background-clip': 'text' }}>I’m flexible</span></Link>
                        </div>
                    }
                    <img src={imgHero} />
                </div >
